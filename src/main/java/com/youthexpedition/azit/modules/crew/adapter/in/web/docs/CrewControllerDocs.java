...
public interface CrewControllerDocs {
    ...
    @ApiErrorCodeExamples({
            "INVALID_CREW_NAME_CHARACTERS", "UNUSABLE_CREW_NAME_KEYWORD", "CREW_JOIN_LIMIT_EXCEEDED", "INVITATION_CODE_GENERATION_FAILED",
    ...
    @ApiErrorCodeExamples({
            ...
            "IMAGE_NOT_UPLOADED", "IMAGE_OWNERSHIP_MISMATCH", "INVALID_CREW_NAME_CHARACTERS", "UNUSABLE_CREW_NAME_KEYWORD",
            "UNAUTHORIZED", "EXPIRED_TOKEN", "INVALID_TOKEN", "TOKEN_REUSE_DETECTED", "BLACKLISTED_TOKEN"
    })
