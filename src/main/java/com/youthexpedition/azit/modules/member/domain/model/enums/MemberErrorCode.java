...
public enum MemberErrorCode implements BaseErrorCode {
    ...
    WITHDRAWAL_GRACE_PERIOD_EXPIRED("WITHDRAWAL_GRACE_PERIOD_EXPIRED", "탈퇴 유예기간이 만료되어 계정을 복구할 수 없습니다.", HttpStatus.FORBIDDEN),
    ...
    TERMS_VERSION_NOT_FOUND("TERMS_VERSION_NOT_FOUND", "약관 버전 정보를 찾을 수 없습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
